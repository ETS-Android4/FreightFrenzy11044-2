...
//@Config
@Autonomous
public class BlueCarousel2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Path ctoparking = new Path(false);
//        ctohub.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.bluecarouseltwo0);
//        ctocarousel.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.bluecarouseltwo1);
//        ctoparking.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.bluecarouseltwo2);

        ctohub.initializePath(20, 20, 10, 4);
        ctocarousel.initializePath(20, 20, 5, 4);
        ctoparking.initializePath(20, 20, 5, 10);
...
//        R.intake.autocontrol(0.8, 2000);
        ...
        t = new ElapsedTime();
        while (!isStopRequested() && !tracker.isDone() && t.milliseconds() < 9000) {
            DrivePower drivePower = tracker.update(t.milliseconds() / 1000.0);
            R.drivetrainTank.setPower(drivePower);
...
//        tracker.rotateTo(160);
        R.carousel.autocontrol(6000, false);
        tracker.setPath(2);
